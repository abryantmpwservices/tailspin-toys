...
Coding standards for comments, TypeScript formatting, data-layer API documentation, and Astro component props are maintained in the [Copilot instruction files](.github/copilot-instructions.md), including the [UI](.github/instructions/ui.instructions.md), [Drizzle](.github/instructions/drizzle.instructions.md), and [Astro](.github/instructions/astro.instructions.md) guidance. Comments should explain intent rather than restate code; exported data-layer functions require TSDoc/JSDoc, and reusable Astro components must document their `Props` interface.
