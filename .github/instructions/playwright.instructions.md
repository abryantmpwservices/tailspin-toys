...
- **Comments**: Explain test intent, accessibility reasoning, or non-obvious interactions. Do not add comments that restate the test steps or assertions, and keep comments current.
